    ...
    <form action="{{ route('clients.update', $client->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Ingrese el apellido del usuario"
            ...
            <div class="col-4">
                ...
                <input type="text" class="form-control" name="address" id="address"
                    placeholder="Ingrese el address del usuario" value="{{ $client->address }}">
            ...
            <div class="col-4">
                ...
                <input type="text" class="form-control" name="population" id="population"
                    placeholder="Ingrese el population del usuario" value="{{ $client->population }}">
